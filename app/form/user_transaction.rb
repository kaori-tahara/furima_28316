class UserTransaction
  ...
  attr_accessor :zip,:city,:address,:building_name,:phone_number,:prefecture
  ...
  with_options presence: true, numericality: { greater_than: 1,message: "can't be blank" } do
   ...
   def save
    shippingaddress.create(zip: zip,city: city,address: address,building_name: building_name,phone_number: phone_number,prefecture_id: prefecture)
  end
