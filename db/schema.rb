...
ActiveRecord::Schema.define(version: 2020_08_14_073548) do
  ...
  create_table "activestrage", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "id"
  end
